export namespace MCProtocol.Bedrock_1_20_61 {
	...
	export type packet_correct_player_move_prediction = {
		...
		tick: bigint;
		/** PredictionType is whether the prediction that was corrected was for the player or for the vehicle it rides. */
	...
	export type Element = "PaperDoll" | "Armour" | "ToolTips" | "TouchControls" | "Crosshair" | "HotBar" | "Health" | "ProgressBar" | "Hunger" | "AirBubbles" | "HourseHealth";
