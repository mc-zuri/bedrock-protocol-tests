export namespace MCProtocol.Bedrock_1_21_124 {
	...
	export type packet_server_script_debug_drawer = {
		shapes: {
			...
			time_left?: number;
			color?: number;
			/** DimensionID is the dimension the shape is drawn in: 0 the overworld, 1 the nether, 2 the end, 3 undefined. */
			dimension_id: number;
