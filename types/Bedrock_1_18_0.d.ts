export namespace MCProtocol.Bedrock_1_18_0 {
	...
	export type CommandOrigin = {
		...
		type: "player" | "block" | "minecart_block" | "dev_console" | "test" | "automation_player" | "client_automation" | "dedicated_server" | "entity" | "virtual" | "game_argument" | "entity_server" | "precompiled" | "game_director_entity_server" | "script";
		uuid: string;
		request_id: string;
		player_entity_id?: {
	...
	export type packet_subchunk = {
		...
		z: number;
		data: ByteArray;
		request_result: "undefined" | "success" | "chunk_not_found" | "invalid_dimension" | "player_not_found" | "y_index_out_of_bounds";
