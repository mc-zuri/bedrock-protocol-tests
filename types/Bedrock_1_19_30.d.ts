export namespace MCProtocol.Bedrock_1_19_30 {
	...
	export type ItemStackRequest = {
		...
		custom_names: string[];
		cause: "chat_public" | "chat_whisper" | "sign_text" | "anvil_text" | "book_and_quill_text" | "command_block_text" | "block_actor_data_text" | "join_event_text" | "leave_event_text" | "slash_command_chat" | "cartography_text";
	};
	/**
	...
	export type AbilityLayers = {
		...
		type: "cache" | "base" | "spectator" | "commands";
