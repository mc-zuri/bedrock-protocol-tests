export namespace MCProtocol.Bedrock_1_26_20 {
	...
	export type packet_serverbound_data_driven_screen_closed = {
		form_id?: number;
		close_reason: "programmatic_close" | "programmatic_close_all" | "client_canceled" | "user_busy" | "invalid_form";
	};
