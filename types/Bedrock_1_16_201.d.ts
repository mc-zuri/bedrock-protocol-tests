export namespace MCProtocol.Bedrock_1_16_201 {
	...
	export type MetadataDictionary = {
		...
		key: "index" | "health" | "variant" | "color" | "nametag" | "owner_eid" | "target_eid" | "air" | "potion_color" | "potion_ambient" | "jump_duration" | "hurt_time" | "hurt_direction" | "paddle_time_left" | "paddle_time_right" | "experience_value" | "minecart_display_block" | "minecart_display_offset" | "minecart_has_display" | "old_swell" | "swell_dir" | "charge_amount" | "enderman_held_runtime_id" | "entity_age" | "player_flags" | "player_index" | "player_bed_position" | "fireball_power_x" | "fireball_power_y" | "fireball_power_z" | "aux_power" | "fish_x" | "fish_z" | "fish_angle" | "potion_aux_value" | "lead_holder_eid" | "scale" | "interactive_tag" | "npc_skin_id" | "url_tag" | "max_airdata_max_air" | "mark_variant" | "container_type" | "container_base_size" | "container_extra_slots_per_strength" | "block_target" | "wither_invulnerable_ticks" | "wither_target_1" | "wither_target_2" | "wither_target_3" | "aerial_attack" | "boundingbox_width" | "boundingbox_height" | "fuse_length" | "rider_seat_position" | "rider_rotation_locked" | "rider_max_rotation" | "rider_min_rotation" | "area_effect_cloud_radius" | "area_effect_cloud_waiting" | "area_effect_cloud_particle_id" | "shulker_peek_id" | "shulker_attach_face" | "shulker_attached" | "shulker_attach_pos" | "trading_player_eid" | "trading_career" | "has_command_block" | "command_block_command" | "command_block_last_output" | "command_block_track_output" | "controlling_rider_seat_number" | "strength" | "max_strength" | "spell_casting_color" | "limited_life" | "armor_stand_pose_index" | "ender_crystal_time_offset" | "always_show_nametag" | "color_2" | "name_author" | "score_tag" | "balloon_attached_entity" | "pufferfish_size" | "bubble_time" | "agent" | "sitting_amount" | "sitting_amount_previous" | "eating_counter" | "flags_extended" | "laying_amount" | "laying_amount_previous" | "duration" | "spawn_time" | "change_rate" | "change_on_pickup" | "pickup_count" | "interact_text" | "trade_tier" | "max_trade_tier" | "trade_experience" | "skin_id" | "spawning_frames" | "command_block_tick_delay" | "command_block_execute_on_first_tick" | "ambient_sound_interval" | "ambient_sound_interval_range" | "ambient_sound_event_name" | "fall_damage_multiplier" | "name_raw_text" | "can_ride_target" | "low_tier_cured_discount" | "high_tier_cured_discount" | "nearby_cured_discount" | "nearby_cured_discount_timestamp" | "hitbox" | "is_buoyant" | "buoyancy_data";
		type: "byte" | "short" | "int" | "float" | "string" | "compound" | "vec3i" | "long" | "vec3f";
		value: number | string | any | vec3i | bigint | vec3f;
	}[];
	export type Link = {
	...
	export type ItemStackRequests = {
		...
		request_id: number;
		actions: {
			type_id: "take" | "place" | "swap" | "drop" | "destroy" | "consume" | "create" | "lab_table_combine" | "beacon_payment" | "craft_recipe" | "craft_recipe_auto" | "craft_creative" | "optional" | "non_implemented" | "results_deprecated";
			count?: number;
			...
			creative_item_network_id?: number;
	...
	export type packet_start_game = {
		...
		is_trial: boolean;
		/** Specifies if the client or server is authoritative over the movement of the player, meaning it controls the movement of it. # https://github.com/pmmp/PocketMine-MP/blob/a43b46a93cb127f037c879b5d8c29cda251dd60c/src/pocketmine/network/mcpe/protocol/types/PlayerMovementType.php#L26 */
		movement_authority: "client" | "server" | "server_v2_rewind";
	...
	export type packet_interact = {
		...
		target_runtime_entity_id: bigint;
	...
	export type packet_player_action = {
		...
		action: "start_break" | "abort_break" | "stop_break" | "get_updated_block" | "drop_item" | "start_sleeping" | "stop_sleeping" | "respawn" | "jump" | "start_sprint" | "stop_sprint" | "start_sneak" | "stop_sneak" | "creative_player_destroy_block" | "dimension_change_ack" | "start_glide" | "stop_glide" | "build_denied" | "continue_break" | "change_skin" | "set_enchatnment_seed" | "swimming" | "stop_swimming" | "start_spin_attack" | "stop_spin_attack" | "ineract_block";
	...
	export type packet_event = {
		runtime_id: bigint;
		event_type: "achievement_awarded" | "entity_interact" | "portal_built" | "portal_used" | "mob_killed" | "cauldron_used" | "player_death" | "boss_killed" | "agent_command" | "agent_created" | "banner_pattern_removed" | "command_executed" | "fish_bucketed" | "mob_born" | "pet_died" | "cauldron_block_used" | "composter_block_used" | "bell_block_used";
	...
	export type packet_player_auth_input = {
		...
		input_mode: "mouse" | "touch" | "game_pad" | "motion_controller";
