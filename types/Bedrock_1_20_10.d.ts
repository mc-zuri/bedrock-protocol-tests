export namespace MCProtocol.Bedrock_1_20_10 {
	...
	export type packet_start_game = {
		...
		/** EditorWorld is a value to dictate if the world is in editor mode, a special mode recently introduced adding "powerful tools for editing worlds, intended for experienced creators." */
