export namespace MCProtocol.Bedrock_1_20_80 {
	...
	export type packet_resource_packs_info = {
		...
		/** Resource Pack Links contains a list of URLs where the client can download required resource packs, as opposed to the current Minecraft sever sending the data over */
		resource_pack_links: {
			id: string;
			url: string;
		}[];
	...
	export type packet_start_game = {
		...
		editor_world_type: "not_editor" | "project" | "test_level";
	...
	export type packet_event = {
		runtime_id: bigint;
		event_type: "achievement_awarded" | "entity_interact" | "portal_built" | "portal_used" | "mob_killed" | "cauldron_used" | "player_death" | "boss_killed" | "agent_command" | "agent_created" | "banner_pattern_removed" | "command_executed" | "fish_bucketed" | "mob_born" | "pet_died" | "cauldron_block_used" | "composter_block_used" | "bell_block_used" | "actor_definition" | "raid_update" | "player_movement_anomaly" | "player_movement_corrected" | "honey_harvested" | "target_block_hit" | "piglin_barter" | "waxed_or_unwaxed_copper" | "code_builder_runtime_action" | "code_builder_scoreboard" | "strider_ridden_in_lava_in_overworld" | "sneak_close_to_sculk_sensor" | "careful_restoration";
	...
	export type packet_completed_using_item = {
		...
		use_method: "equip_armor" | "eat" | "attack" | "consume" | "throw" | "shoot" | "place" | "fill_bottle" | "fill_bucket" | "pour_bucket" | "use_tool" | "interact" | "retrieved" | "dyed" | "traded" | "brushing_completed";
	};
	/**
	...
	export type SubChunkEntryWithoutCaching = {
		...
		payload: ByteArray;
		heightmap_type: "no_data" | "has_data" | "too_high" | "too_low";
		heightmap?: Buffer;
	}[];
	...
	export type packet_camera_instruction = {
		instruction_set?: {
			runtime_id: number;
			ease_data?: {
				type: "Linear" | "Spring" | "InQuad" | "OutQuad" | "InOutQuad" | "InCubic" | "OutCubic" | "InOutCubic" | "InQuart" | "OutQuart" | "InOutQuart" | "InQuint" | "OutQuint" | "InOutQuint" | "InSine" | "OutSine" | "InOutSine" | "InExpo" | "OutExpo" | "InOutExpo" | "InCirc" | "OutCirc" | "InOutCirc" | "InBounce" | "OutBounce" | "InOutBounce" | "InBack" | "OutBack" | "InOutBack" | "InElastic" | "OutElastic" | "InOutElastic";
				duration: number;
			};
			position?: vec3f;
			rotation?: vec2f;
