export namespace MCProtocol.Bedrock_1_26_0 {
	...
	export type packet_clientbound_data_driven_ui_close_all_screens = {
	...
	export interface ClientboundPacketEventMap {
		...
		clientbound_data_driven_ui_close_all_screens: (packet: packet_clientbound_data_driven_ui_close_all_screens) => void;
